...
/**
 * This class represents an explicit method of integration to solve Newton's
 * equations of motion. You must at least override the integrate(Particle,
 * float) function but you may also need to override the stepBy(float) for some
 * methods.
 * 
 * @author bhelx
 * 
...
public abstract class ODESolver {
	 ...
	 * 
	 * @param h
	 *            The change in time to step the simulation by
	 */
	 ...
	 *            The particle
	 * @param h
	 *            The change in time, the time-step
	 */
