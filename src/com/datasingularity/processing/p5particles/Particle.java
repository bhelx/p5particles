...
public class Particle {
    ...
    /**
     * Creates Particle at given location and velocity
     * with given mass and freedom (fixed)
     *
     * @param loc
     * @param vel
     * @param mass
    ...
    /**
     * Apply a force to a particle. Internally it divdes the force vector
     * by the particle's mass and adds to the acceleration.
     *
     * @param force
     */
    ...
    /**
     * Kill a particle. After calling this method, the particle will be
     * removed from the system after the next tick() event.
     *
     */
     ...
     *
     * @param fixed   true for fixed and false for free
     * @return
     */
    ...
    /**
     * Doesn't do anything by default. You must override
