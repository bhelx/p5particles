...
/**
 * This class represents a particles system which may
...
public class ParticleSystem {
     ...
     * Set the global gravity vector for this system
     *
     * @param gravity   a float whcih corresponds to the y axis
     * @return
     */
    ...
    /**
     * The global friction is a dissipative force.
     * on every iteration, the force is calculated
     * by multiplying each particle's velocity by -globalFriciton
    ...
    /**
     * This internally calls ensureCapacity(int) on the
     * ArrayList<Force>. If you have an application that
     * is adding and/or removing forces often and you can take
     * a guess at the maximum amount of forces you will have
     * at one moment, use this.
     *
     * @param maxForces
     */
    ...
    /**
     * Put an existing Particle in the system.
     * p could be any subclass of Particle.
     *
     ...
     * This internally calls ensureCapacity(int) on the
     * ArrayList<Particle> .
     * If you have an application that is adding and/or
     * removing particles often and you can take
     * a guess at the maximum amount of forces you will have
     * at one moment, use this to enhance performance.
     *
     * @param c
     * @param maxParticles
     */
    ...
    /**
     * Apply all the Forces in the system.
    ...
    public void applyForces() {
        ...
        if (globalFriction != 0f) {
            for (Particle p : getParticles()) {
                if (!p.fixed) {
                    PVector dissipativeForce = PVector.mult(p.vel, -globalFriction);
...
//        }
//        if (globalFriction != 0f) {
//            PVector dissipativeForce = PVector.mult(particle.getVel(), -globalFriction);
//            particle.applyForce(dissipativeForce);
//        }
//    }

    /**
     * Clear all the forces in the system.
     * This should probably only be used internally.
     *
     */
...
//        forcesInvolved.ensureCapacity(forces.size()); //will at most have this many
//        for (Force f : forces) {
//            if (f.involves(p)) {
